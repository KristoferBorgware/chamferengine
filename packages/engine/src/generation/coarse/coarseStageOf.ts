 ...
 * builder holding each step's output can start part way down. Land, relief and
 * the peak scale only reach the metre scale, and erosion only reaches erosion,
 * so none of them costs the noise field again.
 *
