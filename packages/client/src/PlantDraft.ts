...
export const PLANT_LAYERS_DEFAULT =
	...
	"Spruce|density=0.9|feature=220|curve=-1:0.05,-0.4:0.15,0.2:0.28,0.7:0.15,1:0.05|biomes=Taiga,Snowy slopes,Boreal moist forest,Boreal wet forest,Boreal rain forest;" +
	...
	"Deadwood|density=0.2|feature=260|curve=-1:0.03,-0.4:0.14,0.1:0.24,0.5:0.12,1:0.03|biomes=Badlands,Dry basin,Boreal desert,Subtropical desert,Tropical desert;" +
