...
export interface Geometry {
	/** Position and colour per vertex: x, y, z, r, g, b. */
 ...
 * rather than sharing them, because the colour is per cell.
 *
 * Cells are emitted once. A cell on a face edge is named by two faces and would
 * otherwise be drawn twice, in two colours, with the second flickering over the
 * first.
 */
