...
| 26 | [What is left before code](docs/26-implementation-readiness.md) | The four core functions, the one that does not exist, and what the 47 open questions actually block |
...
Twenty-six self-contained HTML files. No build step, no dependencies to install —
